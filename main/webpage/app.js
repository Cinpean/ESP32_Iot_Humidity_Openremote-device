...
{
    console.log("get_wifi_conn_status");
    ...
    console.log("wifi_connect_status\n");
...
{
    console.log("into wifi_conn_status");
	wifiConnectInterval = setInterval(getWifiConnectStatus, 2800);
    console.log("after wifi_conn_status");
}
...
function connectWifi(){
    ...
    var shortSelectedSSID = selectedSSID.substring(0, 25); // Adjust length as needed
    var shortPwd = pwd.substring(0, 25); // Adjust length as needed
    var header = { 'ssid' : selectedSSID, 'pwd': pwd };
	...
	$.ajax({
		...
		method: 'POST',
		cache: false,
		headers: {'sid':selectedSSID, 'pwd':pwd},
